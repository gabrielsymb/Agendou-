	...
	<div class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
		<div class="w-full max-w-md rounded bg-white p-6 shadow-lg">
			...
			<div class="mt-6 flex justify-end gap-2">
				<button on:click={fechar} class="rounded bg-gray-300 px-4 py-2 hover:bg-gray-400">Cancelar</button>
				<button on:click={salvar} class="rounded bg-blue-600 px-4 py-2 text-white hover:bg-blue-700">Salvar</button>
			</div>
		</div>
	</div>
{/if}